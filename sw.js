...
// Activate â clean old caches + clean stale completion data
...
// ============================================================
// ===== IndexedDB â shared completion state (page + SW) ======
// ============================================================
...
// ============================================================
// ===== PUSH â receive server-sent push notifications ========
// ============================================================
...
self.addEventListener('notificationclick', e => {
  ...
  e.waitUntil((async () => {
      ...
      await new Promise(resolve => {
        setTimeout(async () => {
          ...
          await self.registration.showNotification(originalTitle, {
            body: 'Snoozed reminder â time to handle this now!',
    ...
    // Default tap â open/focus the app
    if (windowClients.length > 0) {
      return windowClients[0].focus();
    }
